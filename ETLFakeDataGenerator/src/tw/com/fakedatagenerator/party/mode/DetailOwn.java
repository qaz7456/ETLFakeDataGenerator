package tw.com.fakedatagenerator.party.mode;

//本行顧客
public class DetailOwn {
	...
	private String my_customer_flag;// 是否為本行客戶
	private String branch_code;// 歸屬本/分會代號
	private String entity_type;// 顧客類型
	private String entity_sub_type; // 客戶子類型
	private String party_first_name_1;// 中文名字
	private String party_last_name_1;// 中文姓氏
	private String date_of_birth;// 出生年月日/創立日期
	private String deceased_date;// 亡故日期
	private String nationality_code;// 國籍
	private String party_first_name_2;// 英文名字
	private String party_last_name_2;// 英文姓氏
	private String open_date;// 顧客開戶日期
	private String close_date;// 顧客結清日期
	private String gender;// 性別
	private String annual_income;// 年收入
	private String occupation_code;// 職業/行業
	private String marital_status_code;// 婚姻狀況
	private String employer_name;// 服務機構
	private String employer;// 服務機構統編
	private String employee_flag;// 行內員工註記
	private String place_of_birth;// 出生地
	private String multiple_nationality_flag;// 是否具多重國籍(自然人)
	private String nationality_code_2;// 第二國籍
	private String email_address;// 顧客電子郵件
	private String registered_service_atm;// 金融卡約定服務
	private String registered_service_telephone;// 電話約定服務
	private String registered_service_fax;// 傳真約定服務
	private String registered_service_internet;// 網銀約定服務
	private String registered_service_mobile;// 行動銀行約定服務
	private String bearer_stock_flag;// 是否得發行無記名股票 (法人)
	private String bearer_stock_description;// 無記名股票 (法人)資訊說明
	private String foreign_transaction_purpose;// 外國人士居留或交易目的
	private String total_asset;// 顧客aum餘額
	private String trust_total_asset;// 信託客戶aum餘額
	...
	public String getTrust_total_asset() {
		return trust_total_asset;
	}

	public void setTrust_total_asset(String trust_total_asset) {
